    ...
    <div class={styles.homeContainer}>
      ...
      <div>
        ...
        <div class={styles.quickActions}>
          {/* Terminal */}
          <button class={styles.quickActionButton} type="button">
      ...
      <div>
        ...
        <div class={styles.statusGrid}>
          <div class={styles.statusCard}>
            <span class={styles.statusLabel}>Active Sessions</span>
            <span class={styles.statusValue}>{activeSessions()}</span>
          </div>
          <div class={styles.statusCard}>
            <span class={styles.statusLabel}>Worktree</span>
            <span class={styles.statusValue}>{activeWorktreeId() ?? '—'}</span>
          </div>
          <div class={styles.statusCard}>
            <span class={styles.statusLabel}>Git Status</span>
            <span class={styles.statusValue}>—</span>
          </div>
          <div class={styles.statusCard}>
            <span class={styles.statusLabel}>Daily Quest</span>
            <span class={styles.statusValue}>0/3</span>
          </div>
        </div>
      </div>

      {/* Plans Card */}
      <div class={styles.plansCard}>
        <div class={styles.sectionTitle}>Plans</div>
        <div class={styles.planItem}>No plans discovered yet</div>
      </div>
    </div>
  );
}
