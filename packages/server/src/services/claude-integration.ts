...
const PHANTOM_HOOK_COMMAND =
  'cat | FILE=$(jq -r \'.tool_input.file_path // .tool_input.path // empty\') && [ -n "$FILE" ] && echo \'<phantom-ai-reminder>Call mcp__phantom-ai__phantom_graph_context before editing.</phantom-ai-reminder>\' || true';
