...
export const czDarkTokens: ThemeTokens = {
  ...
  cssVars: {
    light: {
      '--phantom-surface-bg': '#ffffff',
      '--phantom-surface-card': '#fafafa',
      '--phantom-surface-elevated': '#f4f4f5',
      '--phantom-border-subtle': '#e4e4e7',
      '--phantom-text-primary': '#000000',
      '--phantom-text-secondary': '#52525b',
    ...
    dark: {
      '--phantom-surface-bg': '#000000',
      '--phantom-surface-card': '#111111',
      '--phantom-surface-elevated': '#18181b',
      '--phantom-border-subtle': '#27272a',
      '--phantom-text-primary': '#fafafa',
      '--phantom-text-secondary': '#71717a',
      '--phantom-text-muted': '#52525b',
      '--phantom-accent-glow': '#4599ac',
      '--phantom-accent-gold': '#FEAC01',
      '--phantom-status-active': '#4ADE80',
      '--phantom-status-warning': '#FB923C',
